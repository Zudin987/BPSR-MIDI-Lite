...
def test_studio_release_version_is_consistent() -> None:
    ...
    assert 'app.APP_VERSION = "Studio 0.4.2-experimental-beta"' in launcher
    assert "filevers=(0, 4, 2, 0)" in version_info
    assert "prodvers=(0, 4, 2, 0)" in version_info
    assert "FileVersion', u'0.4.2-experimental-beta'" in version_info
    assert "ProductVersion', u'0.4.2-experimental-beta'" in version_info
