...
def test_lite_release_version_is_consistent() -> None:
    ...
    assert 'app.APP_VERSION = "3.5.0"' in launcher
    assert "filevers=(3, 5, 0, 0)" in version_info
    assert "prodvers=(3, 5, 0, 0)" in version_info
    assert "FileVersion', u'3.5.0'" in version_info
    assert "ProductVersion', u'3.5.0'" in version_info
    assert "set VERSION=3.5.0" in builder
...
def test_studio_release_version_is_consistent() -> None:
    ...
    assert "filevers=(0, 5, 0, 9)" in version_info
    assert "prodvers=(0, 5, 0, 9)" in version_info
    assert "FileVersion', u'0.5.0-band-accurate-beta.9'" in version_info
    assert "ProductVersion', u'0.5.0-band-accurate-beta.9'" in version_info