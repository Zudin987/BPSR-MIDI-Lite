...
def test_lite_release_version_is_consistent() -> None:
    ...
    assert "filevers=(3, 3, 0, 0)" in version_info
    assert "prodvers=(3, 3, 0, 0)" in version_info
    assert "FileVersion', u'3.3.0'" in version_info
    assert "ProductVersion', u'3.3.0'" in version_info
    assert "set VERSION=3.3.0" in builder
...
def test_studio_release_version_is_consistent() -> None:
    ...
    assert 'app.APP_VERSION = "Studio 0.4.0-experimental-beta"' in launcher
    assert "filevers=(0, 4, 0, 0)" in version_info
    assert "prodvers=(0, 4, 0, 0)" in version_info
    assert "FileVersion', u'0.4.0-experimental-beta'" in version_info
    assert "ProductVersion', u'0.4.0-experimental-beta'" in version_info
