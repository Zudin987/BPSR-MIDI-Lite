...
def test_studio_release_version_is_consistent() -> None:
    ...
    assert 'app.APP_VERSION = "Studio 0.5.0-band-accurate-beta.5"' in launcher
    assert "filevers=(0, 5, 0, 5)" in version_info
    assert "prodvers=(0, 5, 0, 5)" in version_info
    assert "FileVersion', u'0.5.0-band-accurate-beta.5'" in version_info
    assert "ProductVersion', u'0.5.0-band-accurate-beta.5'" in version_info
