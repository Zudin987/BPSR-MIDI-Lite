...
def test_lite_release_version_is_consistent() -> None:
    ...
    assert 'app.APP_VERSION = "3.5.3"' in launcher
    assert "filevers=(3, 5, 3, 0)" in version_info
    assert "prodvers=(3, 5, 3, 0)" in version_info
    assert "FileVersion', u'3.5.3'" in version_info
    assert "ProductVersion', u'3.5.3'" in version_info
    assert "set VERSION=3.5.3" in builder
